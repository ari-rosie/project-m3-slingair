...
//returns an array of flight numbers from the live server
...
// returns the seating object for a flight, from the live server
const getFlightInfo = async (flight) => {
  const reqObj = {
    headers: {Accept: 'application/json'},
...
module.exports = { flights, getFlightNumbers, getFlightInfo };
